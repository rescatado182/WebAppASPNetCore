...
{
    public class CoreProjectRepository : ICoreProjectRepository
    {
        private readonly CoreProjectContext _ctx;
        private readonly ILogger<CoreProjectRepository> _logger;

        public CoreProjectRepository(CoreProjectContext ctx, ILogger<CoreProjectRepository> logger)
        {
            _ctx = ctx;
            _logger = logger;
        }
